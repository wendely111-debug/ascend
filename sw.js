...
const SHELL = [
  ...
  'js/market.js', 'js/routine.js', 'js/medications.js', 'js/checkup.js', 'js/bluetooth.js', 'js/views/live.js', 'js/sleep.js', 'js/views/sleep.js', 'js/views/health.js', 'js/views/timer.js',
