...
export const PT = {
  ...
  // ---- Treino em casa ----
  'Push-Ups_With_Feet_Elevated': { n: 'Flexão com pés elevados', m: 'Peso corporal + sofá/degrau', d: ['Mãos no chão um pouco além dos ombros e pés apoiados no sofá, cama ou degrau.', 'Corpo reto da cabeça aos pés, abdômen contraído.', 'Desça o peito até perto do chão — a carga vai mais para a parte de cima do peito e ombros.', 'Empurre o chão até estender os braços.'] },
  'Push-Up_Wide': { n: 'Flexão aberta', m: 'Peso corporal (chão)', d: ['Mãos bem mais abertas que os ombros, dedos levemente para fora.', 'Corpo reto, abdômen e glúteos contraídos.', 'Desça até o peito quase tocar o chão, sentindo o peitoral alongar.', 'Empurre de volta sem deixar o quadril cair.'] },
  Push_Up_to_Side_Plank: { n: 'Flexão com prancha lateral', m: 'Peso corporal (chão)', d: ['Faça uma flexão normal.', 'Ao subir, gire o corpo para um lado apoiando em uma mão e eleve o outro braço para o teto.', 'Segure 1 segundo com o quadril alto.', 'Volte à posição de flexão e repita girando para o outro lado.'] },
  'Push-Ups_-_Close_Triceps_Position': { n: 'Flexão fechada (tríceps)', m: 'Peso corporal (chão)', d: ['Mãos embaixo do peito, próximas uma da outra.', 'Cotovelos raspando no corpo ao descer.', 'Desça até o peito chegar perto das mãos.', 'Empurre estendendo os braços — o foco é o tríceps. Fica difícil? Apoie os joelhos.'] },
  'Incline_Push-Up': { n: 'Flexão inclinada', m: 'Mesa, bancada ou sofá', d: ['Apoie as mãos na borda de uma mesa/bancada firme, um pouco além dos ombros.', 'Afaste os pés até o corpo ficar reto e inclinado.', 'Desça o peito até a borda, cotovelos a ~45°.', 'Empurre de volta. Quanto mais alto o apoio, mais fácil.'] },
  Inverted_Row: { n: 'Remada invertida', m: 'Mesa firme ou cabo de vassoura entre 2 cadeiras', d: ['Deite embaixo de uma mesa firme e segure a borda com as mãos na largura dos ombros.', 'Corpo reto, calcanhares no chão (joelhos dobrados deixa mais fácil).', 'Puxe o peito até a borda juntando as escápulas.', 'Desça devagar até estender os braços. Teste antes se a mesa aguenta seu peso!'] },
  'Bent_Over_Two-Dumbbell_Row': { n: 'Remada curvada com halteres', m: 'Halteres, galões de água ou mochila', d: ['Em pé, joelhos levemente dobrados, incline o tronco à frente com as costas retas.', 'Segure um peso em cada mão com os braços estendidos.', 'Puxe os pesos até a cintura levando os cotovelos para trás.', 'Desça controlando, sem arredondar a lombar.'] },
  Superman: { n: 'Super-homem (lombar)', m: 'Colchonete ou tapete', d: ['Deite de bruços com braços estendidos à frente.', 'Eleve ao mesmo tempo braços, peito e pernas do chão.', 'Segure 2 segundos contraindo lombar e glúteos.', 'Desça devagar. Olhar para o chão, sem forçar o pescoço.'] },
  'Step-up_with_Knee_Raise': { n: 'Subida no degrau com elevação do joelho', m: 'Degrau, escada ou banquinho firme', d: ['De frente para o degrau, apoie um pé inteiro nele.', 'Empurre com essa perna e suba o corpo.', 'No alto, eleve o joelho da outra perna até a altura do quadril.', 'Desça controlando e repita. Troque de perna ao final da série.'] },
  Butt_Lift_Bridge: { n: 'Ponte de glúteo', m: 'Colchonete ou tapete', d: ['Deite de barriga para cima, joelhos dobrados e pés no chão perto do quadril.', 'Empurre o chão com os calcanhares e eleve o quadril.', 'No alto, ombros-quadril-joelhos em linha reta; aperte os glúteos por 1 segundo.', 'Desça devagar sem encostar totalmente.'] },
  Single_Leg_Glute_Bridge: { n: 'Ponte de glúteo unilateral', m: 'Colchonete ou tapete', d: ['Deite com um pé no chão e a outra perna estendida no ar.', 'Empurre o chão com o calcanhar e eleve o quadril.', 'Mantenha a pelve alinhada, sem girar.', 'Desça devagar. Complete as repetições e troque de perna.'] },
  Glute_Kickback: { n: 'Coice de glúteo (quatro apoios)', m: 'Colchonete ou tapete', d: ['Fique de quatro, mãos sob os ombros e joelhos sob o quadril.', 'Leve uma perna para trás e para cima, joelho dobrado a 90°, sola do pé para o teto.', 'Aperte o glúteo no alto sem arquear a lombar.', 'Volte devagar e repita. Troque de perna.'] },
  Standing_Dumbbell_Calf_Raise: { n: 'Panturrilha em pé no degrau', m: 'Degrau (peso opcional)', d: ['Pontas dos pés na borda de um degrau, segurando no corrimão ou parede.', 'Deixe os calcanhares descerem até alongar bem.', 'Suba na ponta dos pés o máximo possível e segure 1 segundo.', 'Desça devagar. Ficou fácil? Faça com uma perna só ou segure um peso.'] },
  Dead_Bug: { n: 'Dead bug (inseto morto)', m: 'Colchonete ou tapete', d: ['Deite de costas, braços apontando para o teto e joelhos dobrados a 90° no ar.', 'Cole a lombar no chão contraindo o abdômen.', 'Estenda ao mesmo tempo o braço direito para trás e a perna esquerda à frente, sem encostar no chão.', 'Volte e alterne os lados, sem deixar a lombar descolar.'] },
  Dumbbell_Floor_Press: { n: 'Supino no chão com halteres', m: 'Halteres (deitado no chão)', d: ['Deite no chão com joelhos dobrados e um halter em cada mão acima do peito.', 'Desça os halteres até os tríceps tocarem levemente o chão.', 'Cotovelos a ~45° do tronco.', 'Empurre de volta até estender os braços.'] },
  Dumbbell_Squat: { n: 'Agachamento com halteres', m: 'Halteres ou galões de água', d: ['Em pé com um peso em cada mão ao lado do corpo, pés na largura dos ombros.', 'Desça levando o quadril para trás, peito aberto.', 'Vá até as coxas ficarem paralelas ao chão (ou o quanto conseguir sem arredondar as costas).', 'Suba empurrando o chão com o pé inteiro.'] },
  'Stiff-Legged_Dumbbell_Deadlift': { n: 'Stiff com halteres', m: 'Halteres ou galões de água', d: ['Em pé, pesos à frente das coxas, joelhos levemente dobrados.', 'Leve o quadril para trás descendo os pesos rente às pernas.', 'Costas retas; desça até sentir o posterior da coxa alongar.', 'Suba contraindo glúteos e posterior.'] },
  Standing_Dumbbell_Press: { n: 'Desenvolvimento em pé com halteres', m: 'Halteres ou galões de água', d: ['Em pé, halteres na altura dos ombros, palmas para frente.', 'Contraia abdômen e glúteos para não arquear a lombar.', 'Empurre os pesos acima da cabeça até quase estender os braços.', 'Desça devagar até a altura das orelhas.'] },
  Band_Pull_Apart: { n: 'Abertura com elástico', m: 'Elástico / faixa de resistência', d: ['Em pé, segure o elástico à frente do peito com os braços estendidos.', 'Abra os braços para os lados, esticando o elástico até encostar no peito.', 'Junte as escápulas no final.', 'Volte devagar controlando o elástico.'] },
  Tricep_Dumbbell_Kickback: { n: 'Tríceps coice com halteres', m: 'Halteres ou garrafas', d: ['Incline o tronco à frente com as costas retas, apoiando uma mão na cadeira se quiser.', 'Cotovelo colado ao corpo e dobrado a 90°.', 'Estenda o braço para trás até ficar reto, contraindo o tríceps.', 'Volte devagar só dobrando o cotovelo.'] },
  Reverse_Crunch: { n: 'Abdominal infra', m: 'Colchonete ou tapete', d: ['Deite de costas, mãos ao lado do corpo, joelhos dobrados no ar.', 'Leve os joelhos em direção ao peito tirando o quadril do chão.', 'Contraia a parte de baixo do abdômen.', 'Desça devagar sem deixar os pés encostarem no chão.'] },
  Russian_Twist: { n: 'Abdominal russo (rotação)', m: 'Colchonete (peso opcional)', d: ['Sente com joelhos dobrados e incline o tronco para trás, costas retas.', 'Tire os pés do chão (ou mantenha apoiados para facilitar).', 'Gire o tronco levando as mãos para um lado do quadril e depois para o outro.', 'O movimento vem do tronco, não só dos braços.'] },
  Flutter_Kicks: { n: 'Pernada alternada (flutter kick)', m: 'Colchonete ou tapete', d: ['Deite de costas com as mãos sob o quadril.', 'Eleve as pernas estendidas alguns centímetros do chão.', 'Alterne pequenos chutes para cima e para baixo, como nadando.', 'Lombar colada ao chão o tempo todo.'] },
  Side_Bridge: { n: 'Prancha lateral', m: 'Colchonete ou tapete', d: ['Deite de lado apoiado no antebraço, cotovelo sob o ombro.', 'Eleve o quadril até o corpo ficar reto da cabeça aos pés.', 'Mantenha sem deixar o quadril cair, respirando normalmente.', 'Troque de lado. Mais fácil: apoie os joelhos.'] },
  Star_Jump: { n: 'Salto estrela (polichinelo explosivo)', m: 'Peso corporal', d: ['Em pé, agache um pouco com os braços junto ao corpo.', 'Salte abrindo braços e pernas em forma de estrela.', 'Feche o corpo ainda no ar.', 'Aterrisse macio na ponta dos pés e emende o próximo salto. Versão leve: polichinelo.'] },
  Freehand_Jump_Squat: { n: 'Agachamento com salto', m: 'Peso corporal', d: ['Pés na largura dos ombros, mãos atrás da cabeça ou à frente.', 'Agache até as coxas quase paralelas.', 'Salte o mais alto que puder, estendendo o corpo.', 'Aterrisse macio, joelhos levemente dobrados, e já desça para o próximo.'] },
  Split_Jump: { n: 'Afundo com salto', m: 'Peso corporal', d: ['Em posição de afundo, uma perna à frente e outra atrás.', 'Salte trocando as pernas no ar.', 'Aterrisse no afundo com a outra perna à frente, joelho da frente sobre o pé.', 'Continue alternando em ritmo. Versão leve: afundo alternado sem salto.'] },
};
